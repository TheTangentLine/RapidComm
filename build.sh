...
# Create a copy of the binary with the architecture name for Tauri
print_info "Creating Tauri-compatible binary..."
cp build/bin/rapidcomm-server build/bin/rapidcomm-server-aarch64-apple-darwin
